...
import com.dietitianshreya.dtshreyaadmin.models.TemplateModel;

import java.util.ArrayList;
import java.util.List;

/**
 * Created by manyamadan on 24/04/18.
 */
...
public class AdapterGridSingleLine extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterGridSingleLine(Context context, ArrayList<TemplateModel> items) {
        this.items = items;
        ctx = context;
    }
